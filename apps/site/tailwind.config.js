// @ts-check
// Tailwind for the Docusaurus docs (utilities + components only). Preflight is OFF so it
// doesn't reset Docusaurus/Infima. Scans the DS source so the component classes generate.
/** @type {import('tailwindcss').Config} */
module.exports = {
  corePlugins: { preflight: false },
  content: ["./docs/**/*.{md,mdx}", "./src/**/*.{ts,tsx,js,jsx}", "../../packages/ui/src/**/*.{ts,tsx}"],
  theme: {
    extend: {
      colors: {
      ...
      fontFamily: { sans: "var(--nx-font-sans)", mono: "var(--nx-font-mono)" },
    },
  },
  plugins: [],
};
